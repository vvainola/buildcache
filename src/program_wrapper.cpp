...
namespace bcache {
program_wrapper_t::program_wrapper_t(cache_t& cache) : m_cache(cache) {
}

program_wrapper_t::~program_wrapper_t() {
}

bool program_wrapper_t::handle_command(const string_list_t& args, int& return_code) {
  return_code = 1;
...
std::string program_wrapper_t::preprocess_source(const string_list_t&) {
...
std::map<std::string, std::string> program_wrapper_t::get_build_files(const string_list_t&) {
