...
cache_entry_t bcache::redis_cache_provider_t::lookup(const std::string& hash) {
...
void redis_cache_provider_t::add(const std::string& hash,
...
void redis_cache_provider_t::get_file(const std::string& hash,
